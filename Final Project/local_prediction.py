...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
	...
	weight_path = './Unet/stage3_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr) + '_' + str(focal_gamma) 
	...
	patch_train_loader = DataLoader(patch_train_data_set, batch_size=batch_size, num_workers=2, shuffle=True)
